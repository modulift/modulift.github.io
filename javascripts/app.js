...
require.register("components/app/App", function(exports, require, module) {
var App, Navigation, RouteHandler, State, appStore, authStore, cx, div, h1, _ref, _ref1;

authStore = require('stores/auth');

appStore = require('stores/app');

_ref = Exim.DOM, div = _ref.div, h1 = _ref.h1;

cx = Exim.helpers.cx;

_ref1 = Exim.Router, Navigation = _ref1.Navigation, State = _ref1.State, RouteHandler = _ref1.RouteHandler;
...
;require.register("components/auth/Forgot", function(exports, require, module) {
var Forgot, a, div, form, h1, input, p, store, _ref;

store = require('stores/auth');

_ref = Exim.DOM, div = _ref.div, h1 = _ref.h1, p = _ref.p, input = _ref.input, a = _ref.a, form = _ref.form;
...
Forgot = Exim.createView({
  ...
  sendForgot: function(e) {
    var email,
      _this = this;
    e.preventDefault();
    email = this.refs.email.getDOMNode().value;
    return store.actions.forgot(email).then(function() {
  ...
  flip: function(evt) {
    this.props.flip(evt);
    return setTimeout(this.refreshSent, this.props.animDuration);
  },
  ...
  render: function() {
    return form({
      onSubmit: this.sendForgot
    }, !this.state.sent ? [
      h1('Forgot your password, eh?'), p("We'll send a password reset to you:"), div({
        className: 'input-wrapper email'
      }, input({
        ref: 'email',
        type: 'email',
        placeholder: 'Email'
      }))
    ] : [h1('Password reset request sent'), p("Please check your email and click the link to finish resetting your password. If you don't receive the message in a few minutes, please check your spam folder.")], div({
      className: 'spacer'
    }), div({
...
;require.register("components/auth/Login", function(exports, require, module) {
var Navigation, Signin, Tooltip, a, appStore, autofocus, button, config, cx, delay, div, form, h2, icn, img, input, p, slideAnim, spinner, store, _ref;
...
Navigation = Exim.Router.Navigation;

_ref = Exim.DOM, div = _ref.div, h2 = _ref.h2, a = _ref.a, p = _ref.p, form = _ref.form, input = _ref.input, img = _ref.img, icn = _ref.icn, button = _ref.button, spinner = _ref.spinner;
...
Signin = Exim.createView({
  ...
  componentDidMount: function() {
    ...
    if (autofocus) {
      fn = function() {
        return _this.refs.name.getDOMNode().focus();
      };
      return setTimeout(fn, slideAnim + delay);
    }
  },
  ...
  showTooltip: function() {
    var position, target;
    target = this.refs.name.getDOMNode();
    position = {
  ...
  render: function() {
    return form({
      ...
      className: 'input-wrapper password'
    }, input({
      name: 'password',
      ref: 'password',
      type: 'Password',
      ...
      className: "submit visible " + (cx({
        disabled: !(this.state.password && this.state.name)
      })),
      onClick: this.signIn
    }, this.state.signingIn ? (console.log(spinner), spinner()) : 'Sign In'), div({
      className: 'input-bottom'
    }, a({
      href: '',
...
;require.register("components/auth/Signin", function(exports, require, module) {
var Forgot, Index, Link, Login, Navigation, RouteHandler, State, a, addClass, animDuration, appStore, button, config, cx, div, h1, h2, img, removeClass, store, toggle, _ref, _ref1, _ref2;

store = require('stores/auth');

appStore = require('stores/app');

_ref = Exim.DOM, div = _ref.div, h1 = _ref.h1, h2 = _ref.h2, a = _ref.a, button = _ref.button, img = _ref.img;

cx = Exim.helpers.cx;

_ref1 = Exim.Router, Navigation = _ref1.Navigation, State = _ref1.State, RouteHandler = _ref1.RouteHandler, Link = _ref1.Link;

_ref2 = require('lib/utils'), addClass = _ref2.addClass, removeClass = _ref2.removeClass, toggle = _ref2.toggle;
...
Index = Exim.createView({
  ...
  statics: {
    willTransitionTo: function(transition) {
      if (store.get('loggedIn')) {
        return transition.redirect('app');
      }
    }
  },
  getInitialState: function() {
  ...
  componentDidUpdate: function() {
    ...
    if (this.state.error) {
      ...
      return setTimeout((function() {
        return container.classList.remove('shake');
      }), animDuration);
    } else {
      if (this.state.loggedIn) {
  ...
  render: function() {
    ...
    return div({
      ...
      src: '/images/modulift-logo.png'
    })), div({
      className: 'logotype-link'
    }, 'Visit ', a({
      href: "#"
    }, 'www.modulift.com'))), div({
      className: 'flipped auth'
    }, div({
      className: 'flipped-inner'
    }, div({
      className: cx({
        'flipped-container': true,
        flipped: this.state.flipped
      }),
      ref: 'container'
    }, div({
...
;require.register("components/documents/Docs", function(exports, require, module) {
var Brochures, Navigation, RouteHandler, State, a, addClass, cx, div, h1, img, removeClass, toggle, _ref, _ref1, _ref2;

_ref = Exim.DOM, a = _ref.a, div = _ref.div, h1 = _ref.h1, img = _ref.img;
...
Brochures = Exim.createView({
  ...
  setCurrent: function(id, cover, file) {
    var item, _i, _j, _k, _len, _len1, _len2, _ref3, _ref4, _ref5;
    _ref3 = document.querySelectorAll(".documents-menu-item");
    for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
      item = _ref3[_i];
      removeClass(item, 'current');
    }
    _ref4 = document.querySelectorAll(".documents-preview-content");
    for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
      item = _ref4[_j];
      removeClass(item, 'current');
    }
    _ref5 = document.querySelectorAll(".id-" + id);
  ...
  openCurrent: function() {
    return document.location.href = "/viewer.html?file=" + this.current.file;
  },
  render: function() {
    var _this = this;
    return div({
      ...
      className: 'documents-header-text'
    }, 'Document Browser'), div({
      className: 'documents-header-goback',
      onClick: this.goback
    })), div({
      className: 'documents-wrapper'
    }, div({
      className: 'documents-menu'
    }, this.data.docs.map(function(doc) {
      var cover, file, id;
      cover = doc.PDF_Coverpage_img.url();
      file = doc.document.url();
      id = doc.objectId;
      return div({
        className: "documents-menu-item id-" + doc.objectId,
        onClick: _this.setCurrent.bind(doc, id, cover, file)
      }, div({
        className: 'documents-menu-item-icon'
      }, 'PDF'), div({
        className: 'documents-menu-item-label'
      }, doc.document_name, div({
        className: 'documents-menu-item-actions'
      }, a({
        className: 'download',
        href: file
      }))));
      ...
      return div({
        className: "documents-preview-content id-" + doc.objectId,
        onClick: _this.openCurrent
      }, img({
        src: doc.PDF_Coverpage_img.url()
      }));
    }))));
  }
});
...
;require.register("components/documents/Gallery", function(exports, require, module) {
var $, $$, Gallery, Navigation, RouteHandler, State, a, addClass, cx, div, h1, i, img, removeClass, toggle, _ref, _ref1, _ref2;

_ref = Exim.DOM, a = _ref.a, div = _ref.div, h1 = _ref.h1, img = _ref.img, i = _ref.i;
...
Gallery = Exim.createView({
  ...
  next: function() {
    ...
    if (+currentIndex + 1 < +length) {
      return addClass($(".index-" + (+currentIndex + 1)), 'current');
    } else {
      return addClass($(".index-0"), 'current');
    }
  },
  prev: function() {
    var currentIndex, length;
    ...
    if (+currentIndex - 1 >= 0) {
      ...
      return addClass($(".index-" + (+length - 1)), 'current');
    }
  },
  setCurrent: function(id) {
    ...
    if ($('.modal-overlay')) {
      return addClass($('.modal-overlay'), 'showed');
    }
  },
  closeModal: function() {
    if ($('.modal-overlay')) {
      return removeClass($('.modal-overlay'), 'showed');
    }
  },
  openCurrent: function() {
    return document.location.href = "/viewer.html?file=" + this.current.file;
  ...
  render: function() {
    ...
    return div({
    ...
    }, this.data.photos.map(function(image) {
      return div({
        className: 'gallery-item',
        onClick: _this.setCurrent.bind(image, image.objectId)
      }, div({
      ...
      className: 'modal-overlay gallery'
    }, div({
      className: 'controlls'
    }, div({
      ...
      className: 'photobox'
    }, this.data.photos.map(function(image, i) {
      return div({
        className: "photobox-item id-" + image.objectId + " index-" + i,
        'data-index': "" + i
      }, img({
...
;require.register("components/documents/Video", function(exports, require, module) {
var Navigation, RouteHandler, State, Video, a, addClass, cx, div, h1, i, iframe, img, removeClass, toggle, _ref, _ref1, _ref2;

_ref = Exim.DOM, a = _ref.a, div = _ref.div, h1 = _ref.h1, img = _ref.img, i = _ref.i, iframe = _ref.iframe;
...
Video = Exim.createView({
  ...
  next: function() {
    ...
    this.stopVideo(currentIndex);
    length = $('.videobox-item').length;
    $(".videobox-item.current").removeClass('current');
    if (+currentIndex + 1 < +length) {
      return $(".index-" + (+currentIndex + 1)).addClass('current');
    } else {
      return $(".index-0").addClass('current');
    }
  },
  prev: function() {
    var currentIndex, length;
    ...
    if (+currentIndex - 1 >= 0) {
      ...
      return $(".index-" + (+length - 1)).addClass('current');
    }
  },
  setCurrent: function(id) {
    $(".videobox-item").removeClass('current');
    $(".id-" + id).addClass('current');
    return $('.modal-overlay').addClass('showed');
  },
  closeModal: function() {
    var currentIndex;
    currentIndex = $(".videobox-item.current").data('index');
    this.stopVideo(currentIndex);
    return $('.modal-overlay').removeClass('showed');
  },
  openCurrent: function() {
    return document.location.href = "/viewer.html?file=" + this.current.file;
  },
  render: function() {
    ...
    return div({
      ...
      return div({
        className: 'gallery-item',
        onClick: _this.setCurrent.bind(video, video.objectId)
      }, div({
        className: 'gallery-item-image',
        style: {
      ...
      className: 'videobox'
    }, this.data.videos.map(function(video, i) {
      return div({
        className: "videobox-item id-" + video.objectId + " index-" + i,
        'data-index': "" + i
      }, iframe({
        id: "vimeo" + i,
...
;require.register("components/elements/Spinner", function(exports, require, module) {
var Spinner, div, span, spinner, _ref;

_ref = Exim.DOM, div = _ref.div, span = _ref.span, spinner = _ref.spinner;
...
Spinner = Exim.createView({
  ...
  render: function() {
    ...
    args = this.props.state ? div({
      className: 'app-spinner-outer'
    }, spinner()) : React.Children.count(children) === 0 ? div({
      className: 'app-spinner-outer'
    }, this.props.ifEmpty) : children;
    if (this.props.outer) {
      return this.props.outer(args);
    } else {
      return div({
        className: "app-spinner-outer-content " + (this.props.className || '')
      }, args);
    }
  }
});
...
;require.register("components/elements/Tooltip", function(exports, require, module) {
var BaseTooltip, cx, div, icn, li, span, ul, _ref;

cx = Exim.helpers.cx;

_ref = Exim.DOM, div = _ref.div, span = _ref.span, ul = _ref.ul, li = _ref.li, icn = _ref.icn;
...
BaseTooltip = Exim.createView({
  ...
  signin_check: function() {
    return div(null, 'Oops. Invalid email/password combination.');
  },
  email_check: function() {
    return div(null, 'This email already in use!');
  },
  email_validate: function() {
    return div(null, 'Please, use correct email format.');
  },
  password: function(style) {
    var matched, matches;
    matches = this.props.matches;
    matched = function(match, title) {
      return li({
        className: cx({
          matched: match
        })
      }, match ? icn('ios-checkmark-empty') : void 0, title);
    };
    return div(null, span('Password must have at least'), ul(null, matched(matches.characters, '8 characters'), matched(matches.lowerCase, '1 lowercase letter'), matched(matches.upperCase, '1 uppercase letter'), matched(matches.number, '1 number')));
  },
  render: function() {
    var style;
    style = this.props.position || {};
    return div({
      className: "tooltip " + (cx({
        visible: this.props.type
      })),
      style: style
    }, this.props.type ? this[this.props.type]() : void 0);
  }
});
...
;require.register("components/index/Index", function(exports, require, module) {
var $, $$, Index, Navigation, ReactCSSTransitionGroup, RouteHandler, State, a, addClass, button, config, cx, div, h1, h2, img, removeClass, toggle, _ref, _ref1, _ref2;
...
Index = Exim.createView({
  ...
  openModal: function(name) {
    if ($('.modal-overlay') && $(".modal-overlay .modal-" + name)) {
      addClass($('.modal-overlay'), 'showed');
      return addClass($(".modal-overlay .modal-" + name), 'showed');
    }
  },
  closeModal: function() {
    var modal, _i, _len, _ref3, _results;
    if ($('.modal-overlay')) {
      removeClass($('.modal-overlay'), 'showed');
      _ref3 = $$(".modal-overlay .index-modal");
      _results = [];
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        modal = _ref3[_i];
        _results.push(removeClass(modal, 'showed'));
      }
      return _results;
    }
  },
  mailto: function() {
    return document.location.href = 'mailto:xyz@something.com';
  },
  team: function() {
  ...
  navigate: function(alias) {
    if (alias.indexOf('message') > -1) {
      ...
      if (alias.split('/').length > 1) {
        return this.transitionTo(alias.split('/')[0], {
          alias: alias.split('/')[1]
        });
      } else {
        return this.transitionTo(alias);
      }
    }
  },
  render: function() {
    var menu, modals, nav,
      _this = this;
    nav = config.nav;
    menu = nav.map(function(item) {
      var clickHandler;
      clickHandler = _this.openModal.bind(item, item.alias);
      if (item.alias === 'team') {
        clickHandler = _this.team;
      }
      if (item.alias === 'message') {
        clickHandler = _this.mailto;
      }
      return div({
        className: 'index-menu-item',
        onClick: clickHandler
      }, div({
        className: 'index-menu-item-icon'
      }, img({
        src: "/images/icon-" + item.alias + "-s.png"
      })), div({
        className: 'index-menu-item-label'
      }, item.title));
    });
    modals = nav.map(function(item) {
      var _ref3;
      return div({
        className: "index-modal modal-" + item.alias
      }, div({
        className: "subnav"
      }, (_ref3 = item.subnav) != null ? _ref3.map(function(link) {
        return div({
          className: 'subnav-item',
          onClick: _this.navigate.bind(link, link.alias)
        }, link.title);
      }) : void 0));
    });
    return div({
...
;require.register("components/network/Network", function(exports, require, module) {
var Navigation, RouteHandler, State, Team, cx, div, h1, img, _ref, _ref1;

_ref = Exim.DOM, div = _ref.div, h1 = _ref.h1, img = _ref.img;
...
Team = Exim.createView({
  ...
  render: function() {
    ...
    return div({
      ...
      className: 'network-header-goback',
      onClick: this.goback
    }), div({
      className: 'network-header-title',
      onClick: this.goback
    }, 'Our Network')), div({
      className: 'network-map'
    }, div({
      ...
      className: 'network-points-wrapper'
    }, div({
      className: 'network-points-scroller'
    }, this.data.points.map(function(point) {
      window.point = point;
      return div({
        className: "network-points-point"
      }, div({
        className: 'network-points-point-title'
      }, point.Title), div({
        className: 'network-points-point-contact'
      }, point.Contact), div({
        className: 'network-points-point-email'
      }, point.Email), div({
        className: 'network-points-point-role'
      }, point.Role), div({
        className: 'network-points-point-street'
      }, point.Street), div({
        className: 'network-points-point-city'
      }, point.City), div({
        className: 'network-points-point-state'
      }, point.State), div({
        className: 'network-points-point-phone'
      }, point.PhoneNumber));
    })))));
  }
});
...
;require.register("components/network/Team", function(exports, require, module) {
var Navigation, RouteHandler, State, Team, cx, div, h1, img, _ref, _ref1;
  ...
  render: function() {
    ...
    return div({
      ...
      for (_i = 0, _len = team.length; _i < _len; _i++) {
        member = team[_i];
        _results.push(div({
          className: 'network-team-member'
        }, div({
          className: 'network-team-member-avatar'
        }, img({
          src: member.avatar
        })), div({
          className: 'network-team-member-name'
        }, member.name), div({
          className: 'network-team-member-position'
        }, member.position), div({
          className: 'network-team-member-mail'
        }, member.mail)));
      }
      return _results;
    })()));
...
ready = require('lib/utils').ready;

Exim.DOM['spinner'] = function(cls) {
  return Exim.DOM.div({
...
ready().then(function() {
  var appStore;
  appStore = require('stores/app');
  return appStore.actions.start();
});
});

;require.register("lib/humanize", function(exports, require, module) {
(function() {
...
require.register("lib/react-addons", function(exports, require, module) {
/**
...
var api, config, request, serialize;
...
module.exports = {
  ready: function(cb) {
    return new Promise(function(res) {
      return document.addEventListener('DOMContentLoaded', res, false);
    });
  },
  '$': document.querySelector.bind(document),
  ...
  toggle: function(el) {
    var _ref;
    return el.style.display = (_ref = el.style.display === 'none') != null ? _ref : {
      '': 'none'
    };
  }
};
...
var DefaultRoute, Redirect, Route, defaultRouteName, mount, _ref;

_ref = Exim.Router, Route = _ref.Route, DefaultRoute = _ref.DefaultRoute, Redirect = _ref.Redirect;
...
mount = function(name) {
  ...
  return require("components/" + name)().type;
};

module.exports = Route({
  name: 'app',
  handler: mount('app/App'),
  path: '/'
}, Route({
  name: 'signin',
  handler: mount('auth/Signin')
}), Route({
  name: 'forgot',
  handler: mount('auth/Signin')
}), Route({
  ...
  name: 'documents',
  handler: mount('documents/Docs'),
  path: '/documents/:alias'
}), Route({
  name: 'gallery',
  handler: mount('documents/Gallery'),
  path: '/gallery'
}), Route({
  name: 'video',
  handler: mount('documents/Video'),
  path: '/video'
}), Route({
  name: 'team',
  handler: mount('network/Team'),
  path: '/team'
}), Route({
  name: 'network',
  handler: mount('network/Network'),
  path: '/network'
}), Redirect({
  from: '/',
  to: defaultRouteName
...
var appStore, authStore, config, request;
...
module.exports = appStore = Exim.createStore({
  ...
  start: {
    will: function() {
      return authStore.actions.fetchUser()["catch"](function() {
        return console.error('You are not authenticated');
      });
    },
    on: function() {
      return Parse.initialize("W8qSFepvDbmGlUkeFAq6iS1Mkjvvpi1umKgXEsTm", "VNNRUz21VBZwB4lOdqtyKfVtXuvwz8aCs8p3tg4G");
    },
    did: function() {
      var Routes;
      Routes = require('routes');
      return ReactRouter.run(Routes, function(Handler) {
        return React.render(React.createElement(Handler, null), document.querySelector('.modulift-app'));
      });
    }
  }
});
...
;require.register("stores/auth", function(exports, require, module) {
var config, postAvatar, request, store, utils;
...
postAvatar = function(file) {
  ...
  return request.form('user/avatar', form);
};

module.exports = store = Exim.createStore({
  actions: ['findTargets', 'fetchUser', 'uploadAvatar', 'signin', 'signout', 'signup', 'forgot', 'lookup', 'startImpersonation', 'finishImpersonation', 'updateProfile', 'updateAccount', 'checkPin', 'clearPin', 'clearError'],
  initial: {
    loggedIn: false,
    user: {},
  ...
  signin: {
    ...
    on: function(args) {
      ...
      return new Promise(function(res, rej) {
        return Parse.User.logIn(args.name, args.password, {
          success: function(user) {
            return res(user);
          },
          error: function(user, error) {
            return rej(user, error);
          }
        });
      });
    },
    did: function(response) {
      return this.set({
        error: false,
        user: response,
        loggedIn: true
  ...
  signout: {
    on: function() {
      var req;
      return req = request.del('session');
    },
    did: function(args) {
      var _this = this;
      this.set({
  ...
  forgot: {
    on: function(email) {
      return request.post('user/forgot', {
        email: email
      });
    }
  },
  lookup: {
    "while": function(lookingUp) {
      return this.set({
        lookingUp: lookingUp
      });
    },
    on: function(args) {
      this.creds = args;
      return request.post("user/lookup", {
        email: args.email
      });
    },
    did: function() {
  ...
  uploadAvatar: {
    "while": function(avatarUploading) {
      return this.set({
        avatarUploading: avatarUploading
      });
    },
    on: function(args) {
      return postAvatar(args.file);
    },
    did: function(data) {
      var user;
      user = this.get('user');
  ...
  startImpersonation: {
    on: function(user_id) {
      return request.post('impersonation', {
        id: user_id
      });
    },
    did: function(patient) {
      this.set({
        isImpersonating: true,
        impersonationTarget: patient,
        user: patient
      });
      return patientStore.actions.fetch();
    }
  },
  finishImpersonation: {
    on: function() {
      return request.del('impersonation');
    },
    did: function(user) {
      this.set({
        isImpersonating: false,
  ...
  findTargets: {
    on: function(query, cb) {
      this.cb = cb;
      return request.get("patients?q=" + query);
    },
    did: function(targets) {
      return this.cb(targets);
    }
  },
  ...
  updateProfile: {
    ...
    did: function(newProfile) {
      return this.set('profile', newProfile);
    }
  },
  updateAccount: {
    on: function(newAccount) {
      return new Promise(function(resolve) {
        newAccount.current_password = null;
        newAccount.new_password = null;
        Object.keys(newAccount.consents).forEach(function(cons) {
          if (newAccount.consents[cons]) {
            return newAccount.consents[cons] = new Date;
          }
        });
        return resolve(newAccount);
      });
    },
    did: function(newAccount) {
      return this.set('account', newAccount);
    }
  },
  checkPin: {
    "while": function(checkingPin) {
      return this.set({
    ...
    will: function() {
      this.reset('error');
      return this.reset('pinCorrect');
    },
    on: function(pin) {
      return request.post('checkin/pin', {
        pin: pin
      });
    },
    did: function(response) {
