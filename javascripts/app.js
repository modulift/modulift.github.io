...
var App, Navigation, RouteHandler, State, appStore, cx, div, h1, _ref, _ref1;
...
;require.register("components/documents/Brochures", function(exports, require, module) {
...
Brochures = Exim.createView({
  ...
  observe: function() {
    return {
      docs: (new Parse.Query('document_tbl')).equalTo("Filter", "brochure").ascending('createdAt')
    };
  },
  goback: function() {
    return this.transitionTo('index');
...
;require.register("components/documents/CaseStudies", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
DocsList = Exim.createView({
  ...
  openCurrent: function() {
    return document.location.href = "/viewer.html?" + this.current.link;
  },
  render: function() {
    return div({
      className: 'documents'
      ...
      className: 'documents-preview-content',
...
;require.register("components/documents/Catalogues", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/DistributorPacks", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/DocsList", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/ExhibititionSchedule", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/InstructionsUK", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/InstructionsUSA", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/Leaflets", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/LoadCharts", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/News", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/Presentations", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
;require.register("components/documents/PressReleases", function(exports, require, module) {
var DocsList, Navigation, RouteHandler, State, a, cx, div, h1, img, _ref, _ref1;
...
var $, $$, Index, Navigation, ReactCSSTransitionGroup, RouteHandler, State, a, button, config, cx, div, h1, h2, img, _ref, _ref1;
...
Index = Exim.createView({
  ...
  openModal: function(name) {
    if ($('.modal-overlay') && $(".modal-overlay .modal-" + name)) {
      ...
      return $(".modal-overlay .modal-" + name).style.display = "flex";
    }
  },
  closeModal: function() {
    var modal, _i, _len, _ref2, _results;
    if ($('.modal-overlay')) {
      $('.modal-overlay').style.pointerEvents = "none";
      $('.modal-overlay').style.opacity = 0;
      $$(".modal-overlay .index-modal");
      _ref2 = $$(".modal-overlay .index-modal");
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        modal = _ref2[_i];
        _results.push(modal.style.display = "none");
      }
      return _results;
    }
  },
  ...
  render: function() {
    ...
    modals = nav.map(function(item) {
      ...
      return div({
        ...
        className: "subnav"
      }, (_ref2 = item.subnav) != null ? _ref2.map(function(link) {
        return div({
...
Team = Exim.createView({
  ...
  render: function() {
    ...
    return div({
      ...
      _results = [];
      for (_i = 0, _len = network.length; _i < _len; _i++) {
        point = network[_i];
        _results.push(div({
          className: 'point',
          style: {
...
config.hostname = config.production ? 'https://apple-wellnesscenter.com/' : 'http://candyshop.local/';
...
module.exports = appStore = Exim.createStore({
  ...
  start: {
    on: function() {
      Parse.initialize("W8qSFepvDbmGlUkeFAq6iS1Mkjvvpi1umKgXEsTm", "VNNRUz21VBZwB4lOdqtyKfVtXuvwz8aCs8p3tg4G");
      return new Promise(function(res, rej) {
        return Parse.User.logIn('steve', 'testtest', {
